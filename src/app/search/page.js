...
export default function Page() {
    ...
    return (
        <div className="w-full h-screen">
            <div
                className="w-full h px-md flex items-center gap-xs justify-between"
                style={{
                    "--h": "45px"
                }}
            >
                ...
                <div
                    className="relative w-full bg-surface rounded-full h"
                    style={{
                        "--h": "35px"
                    }}
                >
                    <input
                        type="text"
                        className="w-full h-full text-xs px-md pr-xl rounded-full"
                        placeholder="Locales, lugares turísticos..."
                        value={query}
                        autoFocus
                ...
                {!hasQuery && (
                    <div className="w-full px-md py-lg flex flex-col gap-xs">
                        ...
                        <p className="text-sm text-muted">
                            Busca restaurantes, cafeterías, negocios o lugares turísticos.
                        </p>
                    </div>
                )}
                                        ...
                                        >
                                            ...
                                            <div className="w-full flex flex-col gap-2xs">
                                                ...
                                                <p className="text-xs text-muted">
                                                    {business.category || business.business_type || "Local"}
                                                </p>

                                                <p className="text-xs text-muted">
                                                    {business.district || business.province || "Jauja"}
                                                </p>
                                    ...
                                    <li key={place.id}>
                                        ...
                                        >
                                            ...
                                            <div className="w-full flex flex-col gap-2xs">
                                                ...
                                                <p className="text-xs text-muted">
                                                    {place.category || place.type || "Lugar"}
                                                </p>

                                                <p className="text-xs text-muted">
                                                    {place.district || place.province || place.region || "Jauja"}
                                                </p>
                                            </div>
                                        </Link>
                                    </li>

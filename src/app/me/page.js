...
export default function Page () {
    ...
    return (
        <>
            <header className="w-full h flex items-center justify-between px-md" style={{"--h": "50px"}}>
            ...
            <main className="w-full h p-md scroll-y flex flex-col gap-md" style={{"--h": "calc(100dvh - 50px)"}}>
